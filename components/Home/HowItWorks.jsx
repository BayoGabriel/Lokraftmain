  ...
  return (
    <div className="w-full mx-auto px-6 md:px-12 lg:px-36 py-12 md:py-20">
      <motion.h2
        ...
        viewport={{ once: true }}
        className="h2 text-start text-[#D62837] mb-16"
      >
        How it works
      </motion.h2>
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`how-it-works-step pl-6 py-4 mb-8 border-l-8 transition-all duration-700 ${
              ...
              >
                <AnimatePresence mode="wait">
                  <motion.h3
                    ...
                    className={`text-[25px] font-bold transition-colors duration-700 ${
                ...
                <p
                  className={`mt-2 transition-colors duration-700 ${
